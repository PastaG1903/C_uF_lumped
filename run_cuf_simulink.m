...
% VENTED CHAMBER
set_param('untitled_repl/vented_chamber_s','init_fill','0');
...
set_param('untitled_repl/n_radial_channel','init_fill','1');
...
set_param('untitled_repl/mem_pneum_res_s','mem_thick','80'); %um THIS IS THE ONLY VALUE IN MICRONS
...
set_param('untitled_repl/mem_pneum_res_s','theta','0');
