...
% MEM PNEUM CHAMBER
set_param('untitled/multi_mem_res','init_fill','0');
set_param('untitled/multi_mem_res','d','4.04'); %mm
set_param('untitled/multi_mem_res','anglength','160'); %°
set_param('untitled/multi_mem_res','InRad','45'); %mm
set_param('untitled/multi_mem_res','OutRad','62'); %mm
...
set_param('untitled/multi_mem_res','theta','pi/2');
