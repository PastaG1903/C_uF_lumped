...
set_param('titled','FixedStep','0.0001');
...
set_param('titled/Signal Editor','SampleTime','0.0001');

% VENTED CHAMBER
set_param('titled/vented_chamber','init_vol','10000');
...
set_param('titled/n_radial_channel','init_vol','10000');
set_param('titled/n_radial_channel','theta','pi/2');
...
set_param('titled/n_isoradial_channel','init_vol','10000');
set_param('titled/n_isoradial_channel','theta','pi/2');
set_param('titled/n_isoradial_channel','dir','-1'); %-1 when the forward flow goes against the direction of rotation

% MEM PNEUM CHAMBER
set_param('titled/multi_mem_res','init_vol','0');
